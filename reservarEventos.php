    ...
    <main>
        ...
        <div class="container fondoBlanco">
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col">
                  <div class="card">
                    <img src="/imagenes/boda.jpg" class="card-img-top" alt="...">
                  </div>
                </div>
                <div class="col">
                    <div class="card">
                        <table class="table table-hover">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="letrasDescripcion">Puede reservar su fecha especial para hacer los preparativos adecuados y así tenga la mejor celebración de su día tan especial.</td>
                              </tr>
                              <tr>
                                <td class="centrarTexto tituloReservarEvento">Precio:</td>
                                <td class="letrasDescripcion">S/400.00</td>
                              </tr>
                            </tbody>
