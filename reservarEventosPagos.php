    ...
    <main>
        ...
        <div class="container fondoBlanco">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    onkeypress="return event.charCode>=48 && event.charCode<=57" required  class="form-control" id="formGroupExampleInput2" placeholder="Ejemplo: 4214100254031928">
                  </div>
          ...
          <div class="d-grid gap-2 col-6 mx-auto">
            <br>
            <button class="btn btn-primary tituloReservarEvento tamañoBotonReservar colorBoton  letraRoboto negritaLetra botonOvalado" type="button" href="#" data-bs-toggle="modal" data-bs-target="#siguienteFinalizarReserva">¡FINALIZAR RESERVA!</button>
          </div>
        <br>
    </main>
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content ">
          <div class="modal-header">
            ...
            <h5 class="modal-title letraEB negritaLetra">¡MISIÓN CUMPLIDA! <br>
