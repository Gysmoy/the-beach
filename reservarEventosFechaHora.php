    ...
    <main>
        ...
        <div class="container fondoBlanco">
                    ...
                    <tbody>
                      <tr>
                        <td class="letrasDescripcion">
                          <select class="ancharBoton" name="color" id="color">
          ...
          <div class="d-grid gap-2 col-6 mx-auto">
            <br>
            <button class="btn btn-primary tituloReservarEvento tamañoBotonReservar colorBoton letraRoboto negritaLetra botonOvalado" type="button" href="#" data-bs-toggle="modal" data-bs-target="#siguienteFechaHora">Siguiente</button>
          </div>
        <br>
    </main>
     ...
     <div class="modal fade" id="siguienteFechaHora" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <a class="sinSubrayado" href="evento-Platos.php" >
            <div class="d-grid gap-2 col-6 mx-auto ">
          ...
          <a class="sinSubrayado" href="reservarEventosPagos.php" >
            <div class="d-grid gap-2 col-6 mx-auto ">
